...
char list[4][20][40]={
		{".swig","ChrmName","Exceed","LenExceed","Diff","LenDiff","DiffSeqMatlabCode","LenDiffSeqMatlabCode"}, //regular
		{".swig","ChrmName","Exceed","LenExceed","Diff","LenDiff","DiffSeqMatlablpaq","LenDiffSeqMatlablpaq"}, //lpaq
		{".swig","ChrmName",
		 "Diff","LenDiff","DiffSeqMatlabChrmAdd","LenDiffSeqMatlabChrmAdd","DiffSeqMatlabBlockAdd","LenDiffSeqMatlabBlockAdd","BlockAux",
		 "DiffSeqMatlabCode","LenDiffSeqMatlabCode","Start", "Pre", "Smry","SmryAll"}, //random access
		{".swig","ChrmName",
		 "Diff","LenDiff","DiffSeqMatlabChrmAdd","LenDiffSeqMatlabChrmAdd","DiffSeqMatlabBlockAdd","LenDiffSeqMatlabBlockAdd","BlockAux",
		 "DiffSeqMatlabCode","LenDiffSeqMatlabCode","Start", "Pre", "Smry","SmryAll"}, //random access and parallel 
	};
...
//n is the array size
int binsearch(int n,double *array, double search){
	int first = 0;
	int last = n-1;
